...
Feature: Testing of All Element's data providing
  ...
  Scenario Outline: Filling the form with either Wrong or Invalid data in all fields
    ...
    Then Check the Initials name for selected value "<Initials Name expected value>" and provide value for the mismatch error "<if Initials Name not match then Message>"
    When Select the Initials name via radio buttons "<Initials Name radio Button position indexing>".
    And  set "This value need to set the message text field This value need to set the message text field This value need to set the message text fieldThis value need to set the message text field This value need to set the message text field This value need to set the message text field This value need to set the message text fieldThis value need to set the message text field" to message text field
    ...
    When set "12312.234" to comment text field
    ...
    When set "00999222" to your comment text field
    ...
    When set "012134212" to say It here text field
    ...
    Then Check the selected value "<Marital Status expected value>" and provide value for the mismatch error "<if Marital Status not match then Message>"
    ...
    Then Check My Income selected value "<My Income expected value>" and provide value for the mismatch error "<if My Income not match then Message>"
    When Select Annual Salary in Radio buttons "<Annual Salary radio Button position indexing>".
  ...
  Scenario Outline: Filling the form with all the data
    ...
    #there are number(3*4*2*4*5*12*3) possible combination with the data of selection
    Examples:
      |dropdown indexing for Initials Name	|Initials Name expected value	|if Initials Name not match then Message	|Initials Name radio Button position indexing	|value of selection Age Limit	|value of selection of Advertise on Home Page	|Marital Status radio Button position indexing	|Marital Status drop down indexing	|Marital Status expected value	|if Marital Status not match then Message	|My Income drop down indexing	|My Income expected value	|if My Income not match then Message	|Annual Salary radio Button position indexing|
